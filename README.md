...
Example img below is using JS to read the json file that was created by vid2json  
and set a text object at every 10th pixel using the same color of the original pixel.  
